...
You can download the data from [Box](https://missouri.box.com/s/0cuco50evri9vadgmhxgemqv8ciktjg0) or [Github](https://raw.githubusercontent.com/zhengyes/logRt/master/tutorial.csv).
...
Because we just have 0 and 1 for the outcomes, the distribution of outcome follows a binomial distribution Binomial(n, p) where n is the sample size and p is the probability of being obesity. That is the reason why we have family = "binomial" in the code.
